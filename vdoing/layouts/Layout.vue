<template>
  ...
  >
    ...
    <!-- 大图页页 -->
    <HomePage v-else-if="$page.frontmatter.homePage" />
...
export default {
  components: { Home, Navbar, Page, CategoriesPage, TagsPage, ArchivesPage,HomePage ,Sidebar, Footer, Buttons, BodyBgImg },
